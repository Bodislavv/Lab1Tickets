...
namespace TicketsInfrastructure.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(DbticketsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var isUsed = await _context.Teams.AnyAsync(t => t.CountryId == id)
                      || await _context.Venues.AnyAsync(v => v.CountryId == id);

            if (isUsed)
            {
                
                TempData["ErrorMessage"] = "Cannot delete this country as it is being used somewhere.";
                return RedirectToAction(nameof(Index));
            }
